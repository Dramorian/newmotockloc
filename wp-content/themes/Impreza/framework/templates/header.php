...
<head>
	...
	<?php
	$us_meta_viewport = 'width=device-width, maximum-scale=1';
	if ( us_get_option( 'responsive_layout' ) ) {
		$us_meta_viewport .= ', initial-scale=1';
	}
	$us_meta_viewport = apply_filters( 'us_meta_viewport', $us_meta_viewport );
	?>
	<meta name="viewport" content="<?php echo $us_meta_viewport ?>">
