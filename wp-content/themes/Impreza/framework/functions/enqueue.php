...
function us_styles() {
	...
	wp_register_style( 'us-font-awesome', $us_template_directory_uri . '/framework/css/font-awesome.css', array(), '4.4.0', 'all' );
...
function us_jscripts() {
	...
	wp_register_script( 'us-gmap', $us_template_directory_uri . '/framework/js/jquery.gmap.min.js', array( 'jquery' ), '', TRUE );
