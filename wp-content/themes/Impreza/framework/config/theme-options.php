	...
	'generalsettings' => array(
		...
		'fields' => array(
			...
			'logo_image_transparent' => array(
				'title' => __( 'Logo Image in the Transparent Header', 'us' ),
				'description' => __( 'Maximum recommended size is 300px of height (also for retina displays)', 'us' ),
				'type' => 'upload',
				'extension' => 'png,jpg,jpeg,gif,svg',
				'show_if' => array( 'logo_type', '=', 'img' ),
			...
			'favicon' => array(
				'title' => __( 'Favicon', 'us' ),
				'description' => __( 'Upload an ICO/PNG/GIF image that will represent your website\'s favicon', 'us' ),
				'type' => 'upload',
				'std' => '',
			),
			'page_sidebar' => array(
			...
			'og_enabled' => array(
				'title' => __( 'Provide Open Graph Data', 'us' ),
				'type' => 'switch',
	...
	'styling' => array(
		...
		'fields' => array(
			...
			'color_header_search_bg' => array(
				'type' => 'color',
				'text' => __( 'Search Screen Background Color', 'us' ),
				'show_if' => array( 'change_header_colors', '=', TRUE ),
			),
			'color_header_search_text' => array(
				'type' => 'color',
				'text' => __( 'Search Screen Text Color', 'us' ),
				'show_if' => array( 'change_header_colors', '=', TRUE ),
			),
			...
			'custom_css' => array(
				...
				'description' => __( 'Paste your CSS code. Do not include <strong>&lt;pre&gt;&lt;/pre&gt;</strong> tags or any html tag in this field.', 'us' ),
				'type' => 'textarea',
			),
		),
	),
	'headeroptions' => array(
		...
		'fields' => array(
			...
			'header_contacts_phone' => array(
				'title' => __( 'Contact Phone Number', 'us' ),
				'type' => 'text',
				'classes' => 'cols_2_first title_top',
			),
			...
			'header_contacts_custom_icon' => array(
				'title' => __( 'Contact Custom Icon', 'us' ),
			...
			'header_contacts_custom_text' => array(
				'title' => __( 'Contact Custom Text', 'us' ),
	...
	'footeroptions' => array(
		...
		'fields' => array(
			'footer_show_top' => array(
				'title' => __( 'Subfooter', 'us' ),
				'type' => 'switch',
				'text' => __( 'Show <strong>Subfooter</strong> (widgets area)', 'us' ),
				'std' => 0,
			),
			'footer_columns' => array(
				'title' => __( 'Subfooter Columns', 'us' ),
				'description' => sprintf( __( 'Set number of columns in Subfooter. You can populate these columns with <a target="_blank" href="%s">widgets</a>.', 'us' ), admin_url() . 'widgets.php' ),
				'type' => 'radio',
			...
			'footer_show_bottom' => array(
				'title' => __( 'Footer', 'us' ),
				'type' => 'switch',
				'text' => __( 'Show <strong>Footer</strong> (copyright and menu area)', 'us' ),
				'std' => 1,
			),
	...
	'blogoptions' => array(
		...
		'fields' => array(
			...
			'post_sharing_providers' => array(
				...
				'std' => array( 'facebook', 'twitter', 'linkedin', 'gplus', 'pinterest' ),
